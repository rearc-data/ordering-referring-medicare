...
DATASET_NAME='ordering-referring-medicare'
DATASET_ARN='arn:aws:dataexchange:us-east-1:796406704065:data-sets/f3d52b0b6d1b9de9480d90e6e4b0e3be'
PRODUCT_NAME='Order and Referring Medicare Data | CMS'
PRODUCT_ID='prod-piucaavtuvkwq'
SCHEDULE_CRON="cron(0 11 * * ? *)"
REGION='us-east-1'
PROFILE='default'
